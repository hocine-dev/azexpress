...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: 'Email',
      content: 'contact@froidexpress.fr',
      link: 'mailto:contact@froidexpress.fr'
    },
    {
      icon: Clock,
      title: 'Horaires',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Contactez FroidExpress
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Une question ? Un devis ? Notre équipe est à votre disposition 
              pour répondre à tous vos besoins en transport frigorifique.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
                  ...
                  <div key={index} className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      {info.link ? (
                        <a 
                          href={info.link}
                          className="text-gray-600 hover:text-teal-600 transition-colors whitespace-pre-line"
                        >
                          {info.content}
                        </a>
                      ) : (
              ...
              <div className="mt-8 p-6 bg-teal-50 rounded-lg">
                <h3 className="font-semibold text-gray-900 mb-2">Urgences 24h/7j</h3>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          ...
                          onChange={handleChange}
                          placeholder="Décrivez votre besoin en transport frigorifique..."
                          rows={6}
                          required
                        />
                      </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="aspect-w-16 aspect-h-9">
              <iframe
                ...
                title="Localisation FroidExpress à Saint-Denis"
              ></iframe>
            </div>
            <div className="p-6 bg-white">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">FroidExpress</h3>
